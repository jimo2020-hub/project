...
// add new error-code, see mantis[00176]. Chenf, 2009.6.4
#define RE_PARAMETER			0x040e		// error parameter
#define RE_MEMORY				0x040f		// alloc memory failed
// end-add new error-code
